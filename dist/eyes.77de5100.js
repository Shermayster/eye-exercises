...
function forkJoin() {
  ...
  if (sources.length === 1) {
    ...
    if ((0, _isObject.isObject)(first_1) && !(0, _isObservable.isObservable)(first_1)) {
...
function endWith() {
  ...
  return function (source) {
    return _concat.concat.apply(void 0, [source].concat(array));
  };
}
},{"../observable/concat":"node_modules/rxjs/_esm5/internal/observable/concat.js"}],"node_modules/rxjs/_esm5/internal/operators/every.js":[function(require,module,exports) {
"use strict";
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"components/first/first.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/first/first.ts":[function(require,module,exports) {
"use strict";
...
var first_css_1 = __importDefault(require("./first.css"));

exports["default"] = function () {
  console.log(first_css_1["default"].main);
};
...
},{"./first.css":"components/first/first.css"}],"components/router/router.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function RouterComponent() {
    this.domRouter = document.getElementById("router");
  }

  RouterComponent.prototype.setRoute = function (innerComponent) {
...
},{}],"components/second/second.ts":[function(require,module,exports) {
"use strict";
...
var first_1 = require("./components/first/first");

require("./components/first/first.css");

var router_1 = require("./components/router/router");

var second_1 = require("./components/second/second");

var router = new router_1.RouterComponent();
var sub = rxjs_1.fromEvent(document.getElementById("first"), "click");
var sub2 = rxjs_1.fromEvent(document.getElementById("second"), "click");
sub.pipe(operators_1.map(function (e) {
  return new first_1.FirstComponent();
}), operators_1.map(function (firs) {
  return firs.render();
})).subscribe(function (comp) {
  router.setRoute(comp);
});
sub2.pipe(operators_1.map(function (e) {
  return new second_1.SecondComponent();
}), operators_1.map(function (second) {
  return second.render();
})).subscribe(function (comp) {
  router.setRoute(comp);
});
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js","./components/first/first":"components/first/first.ts","./components/first/first.css":"components/first/first.css","./components/router/router":"components/router/router.ts","./components/second/second":"components/second/second.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/eyes.77de5100.js.map